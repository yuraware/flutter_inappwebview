  ...
  UIScrollViewDelegate, UISearchBarDelegate, Disposable
{
  ...
  public override func viewDidLoad() {
    ...
    if #available(iOS 9.0, *) {
      ...
      webView?.bottomAnchor.constraint(equalTo: self.view.bottomAnchor, constant: 0.0).isActive =
        true
      webView?.leadingAnchor.constraint(equalTo: self.view.leadingAnchor, constant: 0.0).isActive =
        true
      ...
      if let webView = webView {
        view.addConstraints([
          NSLayoutConstraint(
            item: webView, attribute: .top, relatedBy: .equal, toItem: view, attribute: .top,
            multiplier: 1, constant: 0),
          NSLayoutConstraint(
            item: webView, attribute: .bottom, relatedBy: .equal, toItem: view, attribute: .bottom,
            multiplier: 1, constant: 0),
          NSLayoutConstraint(
            item: webView, attribute: .left, relatedBy: .equal, toItem: view, attribute: .left,
            multiplier: 1, constant: 0),
          NSLayoutConstraint(
            item: webView, attribute: .right, relatedBy: .equal, toItem: view, attribute: .right,
            multiplier: 1, constant: 0),
        ])
      }
      if let progressBar = progressBar {
        view.addConstraints([
          NSLayoutConstraint(
            item: progressBar, attribute: .top, relatedBy: .equal, toItem: view, attribute: .top,
            multiplier: 1, constant: 0),
          NSLayoutConstraint(
            item: progressBar, attribute: .left, relatedBy: .equal, toItem: view, attribute: .left,
            multiplier: 1, constant: 0),
          NSLayoutConstraint(
            item: progressBar, attribute: .right, relatedBy: .equal, toItem: view,
  ...
  public func initLoad() {
    if let initialFile = initialFile {
      ...
      webView?.loadData(
        data: initialData, mimeType: initialMimeType!, encoding: initialEncoding!, baseUrl: baseUrl,
  ...
  public func setSettings(newSettings: InAppBrowserSettings, newSettingsMap: [String: Any]) {
    ...
    if newSettingsMap["toolbarBottomBackgroundColor"] != nil,
      browserSettings?.toolbarBottomBackgroundColor != newSettings.toolbarBottomBackgroundColor
    {

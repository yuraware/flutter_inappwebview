  ...
  Disposable
{
  ...
  @available(iOS 16.4, *)
  public func webView(
    _ webView: WKWebView, willPresentEditMenuWithAnimator animator: UIEditMenuInteractionAnimating
  ) {
    onCreateContextMenu()
  }
  ...
  @available(iOS 16.4, *)
  public func webView(
    _ webView: WKWebView, willDismissEditMenuWithAnimator animator: UIEditMenuInteractionAnimating
  ) {
    onHideContextMenu()
  }
  ...
  public func prepare() {
    ...
    scrollView.addObserver(
      self, forKeyPath: #keyPath(UIScrollView.contentSize), options: [.new, .old], context: nil)
  ...
  func setSettings(newSettings: InAppWebViewSettings, newSettingsMap: [String: Any]) {
    ...
    if #available(iOS 11.0, *) {
      ...
      if newSettingsMap["contentInsetAdjustmentBehavior"] != nil
        && settings?.contentInsetAdjustmentBehavior != newSettings.contentInsetAdjustmentBehavior
      {
        scrollView.contentInsetAdjustmentBehavior =
          UIScrollView.ContentInsetAdjustmentBehavior.init(
